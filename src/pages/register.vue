<template>
	<div class="flex justify-center items-center">
		<div
			class="glass-card-light flex flex-col lg:flex-row w-full overflow-hidden shadow-xl border border-slate-200 animate-fade-in bg-white/70 backdrop-blur-xl rounded-3xl">
			<!-- Left Side: Illustration & Branding -->
			<div
				class="hidden lg:flex lg:w-1/2 bg-slate-50 relative overflow-hidden flex-col justify-center items-center p-16 border-r border-slate-100">
				<!-- Decorative Elements -->
				...
				<div class="relative z-10 text-center animate-float">
					<img src="https://storage.googleapis.com/devitary-image-host.appspot.com/15848031292911696601-undraw_designer_life_w96d.svg"
						alt="Register illustration" class="max-w-md drop-shadow-xl scale-x-[-1]" />
				...
				<div class="absolute bottom-12 left-0 right-0 flex justify-center gap-4 px-8">
					<div
						class="bg-white/80 backdrop-blur py-2 px-4 rounded-full text-xs text-slate-600 border border-slate-200 shadow-sm">
						✨ Smart Workflow</div>
					<div
						class="bg-white/80 backdrop-blur py-2 px-4 rounded-full text-xs text-slate-600 border border-slate-200 shadow-sm">
						☁️ Cloud Sync</div>
			...
			<div class="w-full lg:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
				<div class="animate-slide-down">
					<h1 class="text-3xl xl:text-4xl font-extrabold text-slate-900 text-center lg:text-left">Create
						Account</h1>
				...
				<div class="w-full mt-10">
					<!-- Form -->
					<form class="space-y-4 animate-slide-up" style="animation-delay: 0.1s;"
						...
						<div class="relative group">
							...
							<input
								...
								type="email" placeholder="Email" v-model="payload.username" />
						</div>
						...
						<div class="relative group">
							...
							<button type="button" @click="toggleConfirmPasswordVisibility"
								class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-indigo-600 transition-colors">
								<Icon :name="showConfirmPassword ? 'mdi:eye-off-outline' : 'mdi:eye-outline'"
									class="w-5 h-5" />
							</button>
						</div>
						...
						<div class="relative group">
							...
							<select
								...
								<option v-for="userType in user_type_list" :key="userType.value"
						...
						<div class="flex items-center text-xs text-slate-500 py-2">
							<input type="checkbox"
								class="mr-2 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500" required />
							<span>I agree to the <a href="#" class="text-indigo-600 hover:underline">Terms of
									Service</a> and <a href="#" class="text-indigo-600 hover:underline">Privacy
									Policy</a></span>
						</div>
