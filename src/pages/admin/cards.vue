				...
				>
					...
					<div class="mt-4 mb-6">
						...
						<p class="text-sm text-gray-700 dark:text-gray-400">
							Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nobis, tempora perferendis
							fuga ipsa atque cupiditate, id reprehenderit odio quaerat quidem autem omnis fugiat
							saepe enim et expedita culpa, harum nam.
						</p>
					</div>
