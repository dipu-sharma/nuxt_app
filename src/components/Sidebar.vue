				...
				<!-- <ul class="mt-6">
					<li class="relative px-6 py-3">
						<NuxtLink
							...
							:class="{
								'p-2 rounded-lg': isActive('/vendor/products'),
								'bg-black text-white':
									themeStore.theme === 'light' && isActive('/vendor/products'),
								'bg-white text-black': themeStore.theme === 'dark' && isActive('/vendor/products'),
							}"
						>
							<svg
								class="w-5 h-5"
					...
					<li class="relative px-6 py-3">
						<NuxtLink
							...
							class="inline-flex items-center w-full text-sm font-semibold"
							:class="{
								'p-2 rounded-lg': isActive('/vendor/orders'),
								'bg-black text-white': themeStore.theme === 'light' && isActive('/vendor/orders'),
								'bg-white text-black': themeStore.theme === 'dark' && isActive('/vendor/orders'),
							}"
						>
							<svg
								class="w-5 h-5"
