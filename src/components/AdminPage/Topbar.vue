    ...
    <div>
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
            <div
                ...
                <!-- Mobile hamburger -->
                <button class="z-10 p-1 mr-5 -ml-1 rounded-md md:hidden focus:outline-none focus:shadow-outline-purple"
                    @click="navStore.toggleSideMenu" @click.self="navStore.toggleSideMenu" aria-label="Menu">
                ...
                <div class="flex justify-center flex-1 lg:mr-32">
                    <div class="relative w-full max-w-xl mr-7 focus-within:text-purple-500">
