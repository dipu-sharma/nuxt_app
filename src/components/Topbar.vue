<template>
	<v-app-bar
		...
		class="z-10 py-4 shadow-md"
	>
		<div
			class="container flex items-center justify-between h-full px-2"
		>
			<!-- Mobile hamburger -->
			<button
				type="button"
				...
				aria-label="Menu"
				@click="navStore.toggleMobileSideMenu()"
			>
			...
			<button
				type="button"
				class="z-10 p-1 mr-5 -ml-1 rounded-md hidden md:block focus:outline-none focus:shadow-outline-purple"
				aria-label="Menu"
				@click="navStore.toggleDesktopSideMenu()"
			>
				<svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
					<path
						fill-rule="evenodd"
